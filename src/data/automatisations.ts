...
export const automatisations: Automatisation[] = [
  ...
  { id: "aqjrEe8zshI3KZ7q", nom: "Validations diverses", metier: "interne", declencheur: "telegram", action: "Enregistre par bouton Telegram la décision de l'opérateur sur une proposition d'agent, et l'expose via une API interne.", actif: true },
